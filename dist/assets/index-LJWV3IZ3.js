...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Rn,depthTest:!1,depthWrite:!1})}function Sp(i,e,t){const n=new Float32Array(ai),r=new D(0,1,0);return new sn({name:"SphericalGaussianBlur",defines:{n:ai,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:ss(),fragmentShader:`
		...
		`,blending:Rn,depthTest:!1,depthWrite:!1})}function al(){return new sn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ss(),fragmentShader:`
		...
		`,blending:Rn,depthTest:!1,depthWrite:!1})}function ol(){return new sn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ss(),fragmentShader:`
	...
	`}class mc extends gn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new lc(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},r=new ur(5,5,5),s=new sn({name:"CubemapFromEquirect",uniforms:Vi(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:Ft,blending:Rn});s.uniforms.tEquirect.value=t;const a=new rn(r,s),o=t.minFilter;return t.minFilter===oi&&(t.minFilter=Ct),new Sh(1,10,this).update(e,a),t.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,n=!0,r=!0){const s=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,n,r);e.setRenderTarget(s)}}function Mp(i){let e=new WeakMap,t=new WeakMap,n=null;function r(u,_=!1){return u==null?null:_?a(u):s(u)}function s(u){if(u&&u.isTexture){const _=u.mapping;if(_===cs||_===us)if(e.has(u)){const x=e.get(u).texture;return o(x,u.mapping)}else{const x=u.image;if(x&&x.height>0){const E=new mc(x.height);return E.fromEquirectangularTexture(i,u),e.set(u,E),u.addEventListener("dispose",c),o(E.texture,u.mapping)}else return null}}return u}function a(u){if(u&&u.isTexture){const _=u.mapping,x=_===cs||_===us,E=_===di||_===Gi;if(x||E){let p=t.get(u);const f=p!==void 0?p.texture.pmremVersion:0;if(u.isRenderTargetTexture&&u.pmremVersion!==f)return n===null&&(n=new rl(i)),p=x?n.fromEquirectangular(u,p):n.fromCubemap(u,p),p.texture.pmremVersion=u.pmremVersion,t.set(u,p),p.texture;if(p!==void 0)return p.texture;{const M=u.image;return x&&M&&M.height>0||E&&M&&l(M)?(n===null&&(n=new rl(i)),p=x?n.fromEquirectangular(u):n.fromCubemap(u),p.texture.pmremVersion=u.pmremVersion,t.set(u,p),u.addEventListener("dispose",h),p.texture):null}}}return u}function o(u,_){return _===cs?u.mapping=di:_===us&&(u.mapping=Gi),u}function l(u){let _=0;const x=6;for(let E=0;E<x;E++)u[E]!==void 0&&_++;return _===x}function c(u){const _=u.target;_.removeEventListener("dispose",c);const x=e.get(_);x!==void 0&&(e.delete(_),x.dispose())}function h(u){const _=u.target;_.removeEventListener("dispose",h);const x=t.get(_);x!==void 0&&(t.delete(_),x.dispose())}function d(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:r,dispose:d}}function Ep(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const r=i.getExtension(n);return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const r=t(n);return r===null&&Fa("WebGLRenderer: "+n+" extension not supported."),r}}}function yp(i,e,t,n){const r={},s=new WeakMap;function a(d){const u=d.target;u.index!==null&&e.remove(u.index);for(const x in u.attributes)e.remove(u.attributes[x]);u.removeEventListener("dispose",a),delete r[u.id];const _=s.get(u);_&&(e.remove(_),s.delete(u)),n.releaseStatesOfGeometry(u),u.isInstancedBufferGeometry===!0&&delete u._maxInstanceCount,t.memory.geometries--}function o(d,u){return r[u.id]===!0||(u.addEventListener("dispose",a),r[u.id]=!0,t.memory.geometries++),u}function l(d){const u=d.attributes;for(const _ in u)e.update(u[_],i.ARRAY_BUFFER)}function c(d){const u=[],_=d.index,x=d.attributes.position;let E=0;if(x===void 0)return;if(_!==null){const M=_.array;E=_.version;for(let b=0,y=M.length;b<y;b+=3){const U=M[b+0],T=M[b+1],C=M[b+2];u.push(U,T,T,C,C,U)}}else{const M=x.array;E=x.version;for(let b=0,y=M.length/3-1;b<y;b+=3){const U=b+0,T=b+1,C=b+2;u.push(U,T,T,C,C,U)}}const p=new(x.count>=65535?ac:sc)(u,1);p.version=E;const f=s.get(d);f&&e.remove(f),s.set(d,p)}function h(d){const u=s.get(d);if(u){const _=d.index;_!==null&&u.version<_.version&&c(d)}else c(d);return s.get(d)}return{get:o,update:l,getWireframeAttribute:h}}function bp(i,e,t){let n;function r(d){n=d}let s,a;function o(d){s=d.type,a=d.bytesPerElement}function l(d,u){i.drawElements(n,u,s,d*a),t.update(u,n,1)}function c(d,u,_){_!==0&&(i.drawElementsInstanced(n,u,s,d*a,_),t.update(u,n,_))}function h(d,u,_){if(_===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,u,0,s,d,0,_);let E=0;for(let p=0;p<_;p++)E+=u[p];t.update(E,n,1)}this.setMode=r,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=h}function Tp(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(s/3);break;case i.LINES:t.lines+=o*(s/2);break;case i.LINE_STRIP:t.lines+=o*(s-1);break;case i.LINE_LOOP:t.lines+=o*s;break;case i.POINTS:t.points+=o*s;break;default:Ve("WebGLInfo: Unknown draw mode:",a);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function Ap(i,e,t){const n=new WeakMap,r=new rt;function s(a,o,l){const c=a.morphTargetInfluences,h=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,d=h!==void 0?h.length:0;let u=n.get(o);if(u===void 0||u.count!==d){let F=function(){v.dispose(),n.delete(o),o.removeEventListener("dispose",F)};var _=F;u!==void 0&&u.texture.dispose();const x=o.morphAttributes.position!==void 0,E=o.morphAttributes.normal!==void 0,p=o.morphAttributes.color!==void 0,f=o.morphAttributes.position||[],M=o.morphAttributes.normal||[],b=o.morphAttributes.color||[];let y=0;x===!0&&(y=1),E===!0&&(y=2),p===!0&&(y=3);let U=o.attributes.position.count*y,T=1;U>e.maxTextureSize&&(T=Math.ceil(U/e.maxTextureSize),U=e.maxTextureSize);const C=new Float32Array(U*T*4*d),v=new ic(C,U,T,d);v.type=pn,v.needsUpdate=!0;const A=y*4;for(let w=0;w<d;w++){const G=f[w],X=M[w],Z=b[w],I=U*T*4*w;for(let V=0;V<G.count;V++){const z=V*A;x===!0&&(r.fromBufferAttribute(G,V),C[I+z+0]=r.x,C[I+z+1]=r.y,C[I+z+2]=r.z,C[I+z+3]=0),E===!0&&(r.fromBufferAttribute(X,V),C[I+z+4]=r.x,C[I+z+5]=r.y,C[I+z+6]=r.z,C[I+z+7]=0),p===!0&&(r.fromBufferAttribute(Z,V),C[I+z+8]=r.x,C[I+z+9]=r.y,C[I+z+10]=r.z,C[I+z+11]=Z.itemSize===4?r.w:1)}}u={count:d,texture:v,size:new Ue(U,T)},n.set(o,u),o.addEventListener("dispose",F)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let x=0;for(let p=0;p<c.length;p++)x+=c[p];const E=o.morphTargetsRelative?1:1-x;l.getUniforms().setValue(i,"morphTargetBaseInfluence",E),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",u.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",u.size)}return{update:s}}function wp(i,e,t,n,r){let s=new WeakMap;function a(c){const h=r.render.frame,d=c.geometry,u=e.get(c,d);if(s.get(u)!==h&&(e.update(u),s.set(u,h)),c.isInstancedMesh&&(c.hasEventListener("dispose",l)===!1&&c.addEventListener("dispose",l),s.get(c)!==h&&(t.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,i.ARRAY_BUFFER),s.set(c,h))),c.isSkinnedMesh){const _=c.skeleton;s.get(_)!==h&&(_.update(),s.set(_,h))}return u}function o(){s=new WeakMap}function l(c){const h=c.target;h.removeEventListener("dispose",l),n.releaseStatesOfObject(h),t.remove(h.instanceMatrix),h.instanceColor!==null&&t.remove(h.instanceColor)}return{update:a,dispose:o}}const Rp={[Gl]:"LINEAR_TONE_MAPPING",[Hl]:"REINHARD_TONE_MAPPING",[Vl]:"CINEON_TONE_MAPPING",[kl]:"ACES_FILMIC_TONE_MAPPING",[Xl]:"AGX_TONE_MAPPING",[Yl]:"NEUTRAL_TONE_MAPPING",[Wl]:"CUSTOM_TONE_MAPPING"};function Cp(i,e,t,n,r){const s=new gn(e,t,{type:i,depthBuffer:n,stencilBuffer:r,depthTexture:n?new Hi(e,t):void 0}),a=new gn(e,t,{type:Dn,depthBuffer:!1,stencilBuffer:!1}),o=new an;o.setAttribute("position",new Zt([-1,3,0,-1,-1,0,3,-1,0],3)),o.setAttribute("uv",new Zt([0,2,0,0,2,0],2));const l=new dh({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),c=new rn(o,l),h=new dc(-1,1,1,-1,0,1);let d=null,u=null,_=!1,x,E=null,p=[],f=!1;this.setSize=function(M,b){s.setSize(M,b),a.setSize(M,b);for(let y=0;y<p.length;y++){const U=p[y];U.setSize&&U.setSize(M,b)}},this.setEffects=function(M){p=M,f=p.length>0&&p[0].isRenderPass===!0;const b=s.width,y=s.height;for(let U=0;U<p.length;U++){const T=p[U];T.setSize&&T.setSize(b,y)}},this.begin=function(M,b){if(_||M.toneMapping===_n&&p.length===0)return!1;if(E=b,b!==null){const y=b.width,U=b.height;(s.width!==y||s.height!==U)&&this.setSize(y,U)}return f===!1&&M.setRenderTarget(s),x=M.toneMapping,M.toneMapping=_n,!0},this.hasRenderPass=function(){return f},this.end=function(M,b){M.toneMapping=x,_=!0;let y=s,U=a;for(let T=0;T<p.length;T++){const C=p[T];if(C.enabled!==!1&&(C.render(M,U,y,b),C.needsSwap!==!1)){const v=y;y=U,U=v}}if(d!==M.outputColorSpace||u!==M.toneMapping){d=M.outputColorSpace,u=M.toneMapping,l.defines={},He.getTransfer(d)===Ye&&(l.defines.SRGB_TRANSFER="");const T=Rp[u];T&&(l.defines[T]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=y.texture,M.setRenderTarget(E),M.render(c,h),E=null,_=!1},this.isCompositing=function(){return _},this.dispose=function(){s.depthTexture&&s.depthTexture.dispose(),s.dispose(),a.dispose(),o.dispose(),l.dispose()}}const _c=new Pt,Ga=new Hi(1,1),gc=new ic,xc=new Vu,vc=new lc,ll=[],cl=[],ul=new Float32Array(16),hl=new Float32Array(9),dl=new Float32Array(4);function Xi(i,e,t){const n=i[0];if(n<=0||n>0)return i;const r=e*t;let s=ll[r];if(s===void 0&&(s=new Float32Array(r),ll[r]=s),e!==0){n.toArray(s,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(s,o)}return s}function vt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function St(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function as(i,e){let t=cl[e];t===void 0&&(t=new Int32Array(e),cl[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Pp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function Dp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(vt(t,e))return;i.uniform2fv(this.addr,e),St(t,e)}}function Lp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(vt(t,e))return;i.uniform3fv(this.addr,e),St(t,e)}}function Up(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(vt(t,e))return;i.uniform4fv(this.addr,e),St(t,e)}}function Ip(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(vt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),St(t,e)}else{if(vt(t,n))return;dl.set(n),i.uniformMatrix2fv(this.addr,!1,dl),St(t,n)}}function Np(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(vt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),St(t,e)}else{if(vt(t,n))return;hl.set(n),i.uniformMatrix3fv(this.addr,!1,hl),St(t,n)}}function Fp(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(vt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),St(t,e)}else{if(vt(t,n))return;ul.set(n),i.uniformMatrix4fv(this.addr,!1,ul),St(t,n)}}function Op(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Bp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(vt(t,e))return;i.uniform2iv(this.addr,e),St(t,e)}}function zp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(vt(t,e))return;i.uniform3iv(this.addr,e),St(t,e)}}function Gp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(vt(t,e))return;i.uniform4iv(this.addr,e),St(t,e)}}function Hp(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Vp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(vt(t,e))return;i.uniform2uiv(this.addr,e),St(t,e)}}function kp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(vt(t,e))return;i.uniform3uiv(this.addr,e),St(t,e)}}function Wp(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(vt(t,e))return;i.uniform4uiv(this.addr,e),St(t,e)}}function Xp(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r);let s;this.type===i.SAMPLER_2D_SHADOW?(Ga.compareFunction=t.isReversedDepthBuffer()?Ka:Za,s=Ga):s=_c,t.setTexture2D(e||s,r)}function Yp(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture3D(e||xc,r)}function qp(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTextureCube(e||vc,r)}function jp(i,e,t){const n=this.cache,r=t.allocateTextureUnit();n[0]!==r&&(i.uniform1i(this.addr,r),n[0]=r),t.setTexture2DArray(e||gc,r)}function Zp(i){switch(i){case 5126:return Pp;case 35664:return Dp;case 35665:return Lp;case 35666:return Up;case 35674:return Ip;case 35675:return Np;case 35676:return Fp;case 5124:case 35670:return Op;case 35667:case 35671:return Bp;case 35668:case 35672:return zp;case 35669:case 35673:return Gp;case 5125:return Hp;case 36294:return Vp;case 36295:return kp;case 36296:return Wp;case 35678:case 36198:case 36298:case 36306:case 35682:return Xp;case 35679:case 36299:case 36307:return Yp;case 35680:case 36300:case 36308:case 36293:return qp;case 36289:case 36303:case 36311:case 36292:return jp}}function Kp(i,e){i.uniform1fv(this.addr,e)}function $p(i,e){const t=Xi(e,this.size,2);i.uniform2fv(this.addr,t)}function Jp(i,e){const t=Xi(e,this.size,3);i.uniform3fv(this.addr,t)}function Qp(i,e){const t=Xi(e,this.size,4);i.uniform4fv(this.addr,t)}function em(i,e){const t=Xi(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function tm(i,e){const t=Xi(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function nm(i,e){const t=Xi(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function im(i,e){i.uniform1iv(this.addr,e)}function rm(i,e){i.uniform2iv(this.addr,e)}function sm(i,e){i.uniform3iv(this.addr,e)}function am(i,e){i.uniform4iv(this.addr,e)}function om(i,e){i.uniform1uiv(this.addr,e)}function lm(i,e){i.uniform2uiv(this.addr,e)}function cm(i,e){i.uniform3uiv(this.addr,e)}function um(i,e){i.uniform4uiv(this.addr,e)}function hm(i,e,t){const n=this.cache,r=e.length,s=as(t,r);vt(n,s)||(i.uniform1iv(this.addr,s),St(n,s));let a;this.type===i.SAMPLER_2D_SHADOW?a=Ga:a=_c;for(let o=0;o!==r;++o)t.setTexture2D(e[o]||a,s[o])}function dm(i,e,t){const n=this.cache,r=e.length,s=as(t,r);vt(n,s)||(i.uniform1iv(this.addr,s),St(n,s));for(let a=0;a!==r;++a)t.setTexture3D(e[a]||xc,s[a])}function fm(i,e,t){const n=this.cache,r=e.length,s=as(t,r);vt(n,s)||(i.uniform1iv(this.addr,s),St(n,s));for(let a=0;a!==r;++a)t.setTextureCube(e[a]||vc,s[a])}function pm(i,e,t){const n=this.cache,r=e.length,s=as(t,r);vt(n,s)||(i.uniform1iv(this.addr,s),St(n,s));for(let a=0;a!==r;++a)t.setTexture2DArray(e[a]||gc,s[a])}function mm(i){switch(i){case 5126:return Kp;case 35664:return $p;case 35665:return Jp;case 35666:return Qp;case 35674:return em;case 35675:return tm;case 35676:return nm;case 5124:case 35670:return im;case 35667:case 35671:return rm;case 35668:case 35672:return sm;case 35669:case 35673:return am;case 5125:return om;case 36294:return lm;case 36295:return cm;case 36296:return um;case 35678:case 36198:case 36298:case 36306:case 35682:return hm;case 35679:case 36299:case 36307:return dm;case 35680:case 36300:case 36308:case 36293:return fm;case 36289:case 36303:case 36311:case 36292:return pm}}class _m{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=Zp(t.type)}}class gm{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=mm(t.type)}}class xm{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const r=this.seq;for(let s=0,a=r.length;s!==a;++s){const o=r[s];o.setValue(e,t[o.id],n)}}}const Gs=/(\w+)(\])?(\[|\.)?/g;function fl(i,e){i.seq.push(e),i.map[e.id]=e}function vm(i,e,t){const n=i.name,r=n.length;for(Gs.lastIndex=0;;){const s=Gs.exec(n),a=Gs.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===r){fl(t,c===void 0?new _m(o,i,e):new gm(o,i,e));break}else{let d=t.map[o];d===void 0&&(d=new xm(o),fl(t,d)),t=d}}}class jr{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<n;++a){const o=e.getActiveUniform(t,a),l=e.getUniformLocation(t,o.name);vm(o,l,this)}const r=[],s=[];for(const a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?r.push(a):s.push(a);r.length>0&&(this.seq=r.concat(s))}setValue(e,t,n,r){const s=this.map[t];s!==void 0&&s.setValue(e,n,r)}setOptional(e,t,n){const r=t[n];r!==void 0&&this.setValue(e,n,r)}static upload(e,t,n,r){for(let s=0,a=t.length;s!==a;++s){const o=t[s],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,r)}}static seqWithValue(e,t){const n=[];for(let r=0,s=e.length;r!==s;++r){const a=e[r];a.id in t&&n.push(a)}return n}}function pl(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const Sm=37297;let Mm=0;function Em(i,e){const t=i.split(`
`),n=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let a=r;a<s;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const ml=new Pe;function ym(i){He._getMatrix(ml,He.workingColorSpace,i);const e=`mat3( ${ml.elements.map(t=>t.toFixed(4))} )`;switch(He.getTransfer(i)){case Qr:return[e,"LinearTransferOETF"];case Ye:return[e,"sRGBTransferOETF"];default:return Te("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function _l(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),s=(i.getShaderInfoLog(e)||"").trim();if(n&&s==="")return"";const a=/ERROR: 0:(\d+)/.exec(s);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`

`+s+`

`+Em(i.getShaderSource(e),o)}else return s}function bm(i,e){const t=ym(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const Tm={[Gl]:"Linear",[Hl]:"Reinhard",[Vl]:"Cineon",[kl]:"ACESFilmic",[Xl]:"AgX",[Yl]:"Neutral",[Wl]:"Custom"};function Am(i,e){const t=Tm[e];return t===void 0?(Te("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Br=new D;function wm(){He.getLuminanceCoefficients(Br);const i=Br.x.toFixed(4),e=Br.y.toFixed(4),t=Br.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)}function Pm(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),a=s.name;let o=1;s.type===i.FLOAT_MAT2&&(o=2),s.type===i.FLOAT_MAT3&&(o=3),s.type===i.FLOAT_MAT4&&(o=4),t[a]={type:s.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function Qi(i){return i!==""}function gl(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function xl(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Dm=/^[ \t]*#include +<([\w\d./]+)>/gm;function Ha(i){return i.replace(Dm,Um)}const Lm=new Map;function Um(i,e){let t=Fe[e];if(t===void 0){const n=Lm.get(e);if(n!==void 0)t=Fe[n],Te('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Ha(t)}const Im=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function vl(i){return i.replace(Im,Nm)}function Nm(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function Sl(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}const Fm={[kr]:"SHADOWMAP_TYPE_PCF",[Ji]:"SHADOWMAP_TYPE_VSM"};function Om(i){return Fm[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Bm={[di]:"ENVMAP_TYPE_CUBE",[Gi]:"ENVMAP_TYPE_CUBE",[is]:"ENVMAP_TYPE_CUBE_UV"};function zm(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Bm[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const Gm={[Gi]:"ENVMAP_MODE_REFRACTION"};function Hm(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Gm[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const Vm={[zl]:"ENVMAP_BLENDING_MULTIPLY",[au]:"ENVMAP_BLENDING_MIX",[ou]:"ENVMAP_BLENDING_ADD"};function km(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Vm[i.combine]||"ENVMAP_BLENDING_NONE"}function Wm(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Xm(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=Om(t),c=zm(t),h=Hm(t),d=km(t),u=Wm(t),_=Rm(t),x=Cm(s),E=r.createProgram();let p,f,M=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		`};class so extends sn{constructor(e){super({type:"LineMaterial",uniforms:no.clone(Nt.line.uniforms),vertexShader:Nt.line.vertexShader,fragmentShader:Nt.line.fragmentShader,clipping:!0}),this.isLineMaterial=!0,this.setValues(e)}get color(){return this.uniforms.diffuse.value}set color(e){this.uniforms.diffuse.value=e}get worldUnits(){return"WORLD_UNITS"in this.defines}set worldUnits(e){e===!0!==this.worldUnits&&(this.needsUpdate=!0),e===!0?this.defines.WORLD_UNITS="":delete this.defines.WORLD_UNITS}get linewidth(){return this.uniforms.linewidth.value}set linewidth(e){this.uniforms.linewidth&&(this.uniforms.linewidth.value=e)}get dashed(){return"USE_DASH"in this.defines}set dashed(e){e===!0!==this.dashed&&(this.needsUpdate=!0),e===!0?this.defines.USE_DASH="":delete this.defines.USE_DASH}get dashScale(){return this.uniforms.dashScale.value}set dashScale(e){this.uniforms.dashScale.value=e}get dashSize(){return this.uniforms.dashSize.value}set dashSize(e){this.uniforms.dashSize.value=e}get dashOffset(){return this.uniforms.dashOffset.value}set dashOffset(e){this.uniforms.dashOffset.value=e}get gapSize(){return this.uniforms.gapSize.value}set gapSize(e){this.uniforms.gapSize.value=e}get opacity(){return this.uniforms.opacity.value}set opacity(e){this.uniforms&&(this.uniforms.opacity.value=e)}get resolution(){return this.uniforms.resolution.value}set resolution(e){this.uniforms.resolution.value.copy(e)}get alphaToCoverage(){return"USE_ALPHA_TO_COVERAGE"in this.defines}set alphaToCoverage(e){this.defines&&(e===!0!==this.alphaToCoverage&&(this.needsUpdate=!0),e===!0?this.defines.USE_ALPHA_TO_COVERAGE="":delete this.defines.USE_ALPHA_TO_COVERAGE)}}const ks=new rt,Rl=new D,Cl=new D,Et=new rt,yt=new rt,hn=new rt,Ws=new D,Xs=new ft,bt=new Th,Pl=new D,Hr=new Qn,Vr=new cr,dn=new rt;let fn,ci;function Dl(i,e,t){return dn.set(0,0,-e,1).applyMatrix4(i.projectionMatrix),dn.multiplyScalar(1/dn.w),dn.x=ci/t.width,dn.y=ci/t.height,dn.applyMatrix4(i.projectionMatrixInverse),dn.multiplyScalar(1/dn.w),Math.abs(Math.max(dn.x,dn.y))}function B_(i,e){const t=i.matrixWorld,n=i.geometry,r=n.attributes.instanceStart,s=n.attributes.instanceEnd,a=Math.min(n.instanceCount,r.count);for(let o=0,l=a;o<l;o++){bt.start.fromBufferAttribute(r,o),bt.end.fromBufferAttribute(s,o),bt.applyMatrix4(t);const c=new D,h=new D;fn.distanceSqToSegment(bt.start,bt.end,h,c),h.distanceTo(c)<ci*.5&&e.push({point:h,pointOnLine:c,distance:fn.origin.distanceTo(h),object:i,face:null,faceIndex:o,uv:null,uv1:null})}}function z_(i,e,t){const n=e.projectionMatrix,s=i.material.resolution,a=i.matrixWorld,o=i.geometry,l=o.attributes.instanceStart,c=o.attributes.instanceEnd,h=Math.min(o.instanceCount,l.count),d=-e.near;fn.at(1,hn),hn.w=1,hn.applyMatrix4(e.matrixWorldInverse),hn.applyMatrix4(n),hn.multiplyScalar(1/hn.w),hn.x*=s.x/2,hn.y*=s.y/2,hn.z=0,Ws.copy(hn),Xs.multiplyMatrices(e.matrixWorldInverse,a);for(let u=0,_=h;u<_;u++){if(Et.fromBufferAttribute(l,u),yt.fromBufferAttribute(c,u),Et.w=1,yt.w=1,Et.applyMatrix4(Xs),yt.applyMatrix4(Xs),Et.z>d&&yt.z>d)continue;if(Et.z>d){const b=Et.z-yt.z,y=(Et.z-d)/b;Et.lerp(yt,y)}else if(yt.z>d){const b=yt.z-Et.z,y=(yt.z-d)/b;yt.lerp(Et,y)}Et.applyMatrix4(n),yt.applyMatrix4(n),Et.multiplyScalar(1/Et.w),yt.multiplyScalar(1/yt.w),Et.x*=s.x/2,Et.y*=s.y/2,yt.x*=s.x/2,yt.y*=s.y/2,bt.start.copy(Et),bt.start.z=0,bt.end.copy(yt),bt.end.z=0;const E=bt.closestPointToPointParameter(Ws,!0);bt.at(E,Pl);const p=nc.lerp(Et.z,yt.z,E),f=p>=-1&&p<=1,M=Ws.distanceTo(Pl)<ci*.5;if(f&&M){bt.start.fromBufferAttribute(l,u),bt.end.fromBufferAttribute(c,u),bt.start.applyMatrix4(a),bt.end.applyMatrix4(a);const b=new D,y=new D;fn.distanceSqToSegment(bt.start,bt.end,y,b),t.push({point:y,pointOnLine:b,distance:fn.origin.distanceTo(y),object:i,face:null,faceIndex:u,uv:null,uv1:null})}}}class G_ extends rn{constructor(e=new Ec,t=new so({color:Math.random()*16777215})){super(e,t),this.isLineSegments2=!0,this.type="LineSegments2"}computeLineDistances(){const e=this.geometry,t=e.attributes.instanceStart,n=e.attributes.instanceEnd,r=new Float32Array(2*t.count);for(let a=0,o=0,l=t.count;a<l;a++,o+=2)Rl.fromBufferAttribute(t,a),Cl.fromBufferAttribute(n,a),r[o]=o===0?0:r[o-1],r[o+1]=r[o]+Rl.distanceTo(Cl);const s=new Oa(r,2,1);return e.setAttribute("instanceDistanceStart",new qn(s,1,0)),e.setAttribute("instanceDistanceEnd",new qn(s,1,1)),this}raycast(e,t){const n=this.material.worldUnits,r=e.camera;r===null&&!n&&console.error('LineSegments2: "Raycaster.camera" needs to be set in order to raycast against LineSegments2 while worldUnits is set to false.');const s=e.params.Line2!==void 0&&e.params.Line2.threshold||0;fn=e.ray;const a=this.matrixWorld,o=this.geometry,l=this.material;ci=l.linewidth+s,o.boundingSphere===null&&o.computeBoundingSphere(),Vr.copy(o.boundingSphere).applyMatrix4(a);let c;if(n)c=ci*.5;else{const d=Math.max(r.near,Vr.distanceToPoint(fn.origin));c=Dl(r,d,l.resolution)}if(Vr.radius+=c,fn.intersectsSphere(Vr)===!1)return;o.boundingBox===null&&o.computeBoundingBox(),Hr.copy(o.boundingBox).applyMatrix4(a);let h;if(n)h=ci*.5;else{const d=Math.max(r.near,Hr.distanceToPoint(fn.origin));h=Dl(r,d,l.resolution)}Hr.expandByScalar(h),fn.intersectsBox(Hr)!==!1&&(n?B_(this,t):z_(this,r,t))}onBeforeRender(e){const t=this.material.uniforms;t&&t.resolution&&(e.getViewport(ks),this.material.uniforms.resolution.value.set(ks.z,ks.w))}}class ao extends Ec{constructor(){super(),this.isLineGeometry=!0,this.type="LineGeometry"}setPositions(e){const t=e.length-3,n=new Float32Array(2*t);for(let r=0;r<t;r+=3)n[2*r]=e[r],n[2*r+1]=e[r+1],n[2*r+2]=e[r+2],n[2*r+3]=e[r+3],n[2*r+4]=e[r+4],n[2*r+5]=e[r+5];return super.setPositions(n),this}setColors(e){const t=e.length-3,n=new Float32Array(2*t);for(let r=0;r<t;r+=3)n[2*r]=e[r],n[2*r+1]=e[r+1],n[2*r+2]=e[r+2],n[2*r+3]=e[r+3],n[2*r+4]=e[r+4],n[2*r+5]=e[r+5];return super.setColors(n),this}setFromPoints(e){const t=e.length-1,n=new Float32Array(6*t);for(let r=0;r<t;r++)n[6*r]=e[r].x,n[6*r+1]=e[r].y,n[6*r+2]=e[r].z||0,n[6*r+3]=e[r+1].x,n[6*r+4]=e[r+1].y,n[6*r+5]=e[r+1].z||0;return super.setPositions(n),this}fromLine(e){const t=e.geometry;return this.setPositions(t.attributes.position.array),this}}class H_ extends G_{constructor(e=new ao,t=new so({color:Math.random()*16777215})){super(e,t),this.isLine2=!0,this.type="Line2"}}const Yt=document.getElementById("right-panel"),vn=document.getElementById("archive-canvas"),dr=new y_({canvas:vn,antialias:!0,alpha:!0});dr.setSize(Yt.clientWidth,Yt.clientHeight);dr.setPixelRatio(window.devicePixelRatio);const ki=new Ku;ki.background=null;const jt=new Xt(75,Yt.clientWidth/Yt.clientHeight,.1,1e3);jt.position.z=20;const xt=new T_(jt,dr.domElement);xt.autoRotate=!0;xt.autoRotateSpeed=2.2;xt.enableDamping=!0;xt.dampingFactor=.05;xt.enablePan=!0;xt.enableZoom=!0;xt.zoomSpeed=-.5;xt.rotateSpeed=.5;xt.minDistance=4;xt.maxDistance=20;xt.touches={ONE:Yn.ROTATE,TWO:Yn.DOLLY_PAN};const ui=new D(0,0,20),Wi=new D(0,0,0),Ll=.05;let mi=!1,Ni=null,ir=null;const Ul=.003;vn.addEventListener("pointermove",i=>{if(i.buttons!==0)return;if(mi=!1,Ni===null){Ni=i.clientX,ir=i.clientY;return}const e=i.clientX-Ni,t=i.clientY-ir;Ni=i.clientX,ir=i.clientY;const n=new za;n.setFromVector3(jt.position.clone().sub(xt.target)),n.theta-=e*Ul,n.phi-=t*Ul,n.phi=Math.max(.1,Math.min(Math.PI-.1,n.phi));const r=new D().setFromSpherical(n).add(xt.target);jt.position.copy(r),xt.update()});vn.addEventListener("pointerleave",()=>{Ni=null,ir=null});vn.addEventListener("pointerenter",()=>{Ni=null,ir=null});const yc={1:{label:"Boats",description:"Vessels, crossings, the sea.",video:"videos/1.mp4",lineColor:16777215},2:{label:"Archive",description:"Photographs, documents, memory.",video:"videos/2.mp4",lineColor:16777215},3:{label:"Landscape",description:"Coast, horizon, land.",video:"videos/3.mp4",lineColor:16777215},4:{label:"Human",description:"Faces, hands, figures.",video:"videos/4.mp4",lineColor:16777215},5:{label:"Time",description:"Past and present, layered.",video:"videos/5.mp4",lineColor:16777215}},lr=[],V_=new xh;fetch("/images/metadata.json").then(i=>i.json()).then(i=>{Object.entries(i).forEach(([e,t])=>{Object.entries(t).forEach(([n,r])=>{const s=`/images/${e}/${n}`;V_.load(s,a=>{const o=a.image.width/a.image.height,l=1.5+Math.random()*1.5,c=l/o,h=new hr(l,c),d=new to({map:a,transparent:!0,alphaTest:.1}),u=new rn(h,d);u.position.x=(Math.random()-.5)*10,u.position.y=(Math.random()-.5)*20,u.position.z=(Math.random()-.5)*9,u.userData.layer=e,u.userData.title=(r==null?void 0:r.title)??"",u.userData.description=(r==null?void 0:r.description)??"",ki.add(u),lr.push(u)})})})}).catch(i=>console.warn("Could not load metadata.json",i));const Zn=document.getElementById("main-video"),k_=document.getElementById("video-source"),hi=document.getElementById("subtitle-video"),W_=document.getElementById("subtitle-source"),bc=document.getElementById("subtitle-text");function Tc(i){k_.src=i,Zn.muted=!1,Zn.load(),Zn.play()}Zn.addEventListener("timeupdate",()=>{Zn.duration&&Zn.currentTime>Zn.duration-.3&&(hi.currentTime=0,hi.play())});const Il=document.getElementById("subtitle-current"),Nl=document.getElementById("subtitle-next"),X_="Landfall: A five-part documentary and interactive archive.",Y_="press a chapter to begin · use the trackpad and arrows to explore";function Fl(i,e,t=40){return new Promise(n=>{i.textContent="";let r=0;const s=setInterval(()=>{i.textContent+=e[r],r++,r>=e.length&&(clearInterval(s),n())},t)})}let Ys=!1;async function Ac(){Ys||(Ys=!0,Nl.textContent="",Il.textContent="",await Fl(Il,X_,40),await new Promise(i=>setTimeout(i,2e3)),await Fl(Nl,Y_,30),Ys=!1)}Ac();const er=document.getElementById("header-desc");let oo=null;function wc(i){oo&&(!i.title&&!i.description||(er.innerHTML=`
    <span style="font-style:normal; font-weight:normal; text-transform:uppercase; color: #4a779f">${i.title}</span>
    <span style="margin-left: auto; padding-left: 24px; font-style:italic; color: #f04b26">${i.description}</span>
  `,er.style.display="flex",er.style.justifyContent="space-between",er.style.opacity="1"))}function lo(){er.style.opacity="0"}const Ol=new Eh,qs=new Ue;let Zr=null;vn.addEventListener("mousemove",i=>{const e=vn.getBoundingClientRect();qs.x=(i.clientX-e.left)/e.width*2-1,qs.y=-((i.clientY-e.top)/e.height)*2+1;const t=lr.filter(r=>r.visible);t.forEach(r=>r.updateWorldMatrix(!0,!1)),Ol.setFromCamera(qs,jt);const n=Ol.intersectObjects(t);n.length>0?(Zr=n[0].object,wc(Zr.userData)):(Zr=null,lo())});vn.addEventListener("mouseleave",()=>{Zr=null,lo()});vn.addEventListener("dblclick",()=>{ui.set(0,0,20),Wi.set(0,0,0),mi=!0});let kn=-1,Wn=[];function Bl(i){const e=new D;i.getWorldPosition(e),ui.copy(e).add(new D(0,0,3)),Wi.copy(e),mi=!0,wc(i.userData)}vn.addEventListener("contextmenu",i=>i.preventDefault());vn.addEventListener("mousedown",i=>{i.isTrusted&&Wn.length!==0&&(i.button===0&&(kn=(kn-1+Wn.length)%Wn.length,Bl(Wn[kn])),i.button===2&&(kn=(kn+1)%Wn.length,Bl(Wn[kn])))});let Ut=null;const q_=5;function Rc(i){const e=[];for(let t=0;t<i.length;t++)for(let n=t+1;n<i.length;n++){i[t].updateWorldMatrix(!0,!1),i[n].updateWorldMatrix(!0,!1);const r=new D,s=new D;i[t].getWorldPosition(r),i[n].getWorldPosition(s),r.distanceTo(s)<q_&&e.push(r.x,r.y,r.z,s.x,s.y,s.z)}return e}function j_(i,e=16777215){Cc();const t=Rc(i);if(t.length===0)return;const n=new ao;n.setPositions(t);const r=new so({color:e,linewidth:1,transparent:!0,opacity:.4,resolution:new Ue(Yt.clientWidth,Yt.clientHeight),dashed:!1});Ut=new H_(n,r),Ut.userData.sourceMeshes=i,ki.add(Ut)}function Cc(){Ut&&(Ut.geometry.dispose(),Ut.material.dispose(),ki.remove(Ut),Ut=null)}function Z_(){if(!Ut)return;const i=Ut.userData.sourceMeshes,e=Rc(i);Ut.geometry.dispose();const t=new ao;e.length>0&&t.setPositions(e),Ut.geometry=t}function K_(i){oo=i,bc.style.display="none",W_.src=`videos/subtitle_${i}.mp4`,hi.style.display="block",hi.load(),hi.play(),xt.autoRotate=!1,lr.forEach(n=>{n.visible=n.userData.layer===i});const e=yc[i];Tc(e.video);const t=lr.filter(n=>n.userData.layer===i);j_(t,e.lineColor),Wn=t,kn=-1,ui.set(0,0,20),Wi.set(0,0,0),mi=!0}function $_(){oo=null,hi.style.display="none",hi.pause(),bc.style.display="flex",Zn.muted=!0,xt.autoRotate=!0,lr.forEach(i=>{i.visible=!0}),lo(),Cc(),Tc("videos/loading_noText.mp4"),Wn=[],kn=-1,ui.set(0,0,20),Wi.set(0,0,0),mi=!0,Ac()}window.addEventListener("keydown",i=>{i.key==="0"?$_():yc[i.key]&&K_(i.key)});window.addEventListener("resize",()=>{jt.aspect=Yt.clientWidth/Yt.clientHeight,jt.updateProjectionMatrix(),dr.setSize(Yt.clientWidth,Yt.clientHeight),Ut&&Ut.material.resolution.set(Yt.clientWidth,Yt.clientHeight)});function Pc(){requestAnimationFrame(Pc),mi&&(jt.position.lerp(ui,Ll),xt.target.lerp(Wi,Ll),jt.position.distanceTo(ui)<.05&&(jt.position.copy(ui),xt.target.copy(Wi),mi=!1)),xt.update(),ki.children.forEach(i=>{i!==Ut&&i.quaternion.copy(jt.quaternion)}),Z_(),dr.render(ki,jt)}Pc();
